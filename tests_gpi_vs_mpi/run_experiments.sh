...
DIR_MXM_EXAMPLE=${DIR_MXM_EXAMPLE:-../../chameleon_gpi_apps/applications/matrix_example}
mkdir -p ${DIR_RESULT}
...
function run_experiments()
{
    ...
    do
        ...
        do
            ...
            do
                module switch chameleon chameleon/chameleon_mpi
                ...
                module switch chameleon chameleon/chameleon.rel
                eval "${MPI_EXEC_CMD} -np ${N_PROCS} ${MPI_EXPORT_VARS} ${CMD_VTUNE_PREFIX} ${DIR_MXM_EXAMPLE}/main_gpi $g ${MXM_PARAMS}" &> ${DIR_RESULT}/results_${exec_version}_${g}_${t}t_${r}_gpi.log
            done
        done
    done
}
