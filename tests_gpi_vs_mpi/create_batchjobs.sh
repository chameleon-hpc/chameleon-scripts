...
export N_PROCS=2
sbatch --nodes=1 --ntasks-per-node=2 --cpus-per-task=28 --job-name=mxm_multi_task_migration_2n_sm --output=mxm_multi_task_migration_2n_sm.%J.txt --export=DIR_CH_REGULAR_INSTALL,DIR_CH_SEPARATE_INSTALL,IS_DISTRIBUTED,IS_SEPARATE,CUR_DATE_STR,N_PROCS run_experiments.sh
...
export IS_SEPARATE=0
export N_PROCS=2
sbatch --nodes=2 --ntasks-per-node=1 --cpus-per-task=28 --job-name=mxm_multi_task_migration_2n_dm --output=mxm_multi_task_migration_2n_dm.%J.txt --export=IS_DISTRIBUTED,IS_SEPARATE,CUR_DATE_STR,N_PROCS run_experiments.sh
#export IS_SEPARATE=1
