#!/bin/bash
#BSUB -J "batch_analyse_threshold_packing_type_dm"
#BSUB -o batch_analyse_threshold_packing_type_dm.out.%J
#BSUB -e batch_analyse_threshold_packing_type_dm.err.%J
#BSUB -W 09:00
##BSUB -m c24m128
#BSUB -m c144m1024
#BSUB -n 2
...
module li
python3.6 ./analyze_threshold_packing_type.py "distributed_buffer" 13

module unload chameleon-lib
module load chameleon-lib/1.0-zero-copy
module li
python3.6 ./analyze_threshold_packing_type.py "distributed_zero-copy" 13
