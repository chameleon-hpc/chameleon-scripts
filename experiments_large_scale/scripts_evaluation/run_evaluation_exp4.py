...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Usage: python .\\run_evaluation_exp4 <folder_path_output_files>")
        exit(1)
    ...
    for idx_sig in range(len(list_signals)):
        ...
        plot_data_normal(tmp_target_file_path, unique_nr_nodes, arr_types, arr_data_plot[idx_sig], list_signals_labels[idx_sig], "# nodes", list_y_labels[idx_sig], enforced_y_limit=list_y_limit[idx_sig])
