...
export ENVS_FOR_EXPORT="PATH,CPLUS_INCLUDE_PATH,C_INCLUDE_PATH,CPATH,INCLUDE,LD_LIBRARY_PATH,LIBRARY_PATH,OMP_NUM_THREADS,OMP_PLACES,OMP_PROC_BIND,MIN_ABS_LOAD_IMBALANCE_BEFORE_MIGRATION,CHAMELEON_TOOL_LIBRARIES"
