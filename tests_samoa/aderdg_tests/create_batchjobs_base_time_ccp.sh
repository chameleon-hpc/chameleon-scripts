...
make clean 
cmake -DCMAKE_INSTALL_PREFIX="~/chameleon/chameleon-lib/intel_1.0_rep_mode_0" -DCMAKE_CXX_FLAGS="-DCHAM_STATS_RECORD -DCHAM_STATS_PRINT -DCHAM_REPLICATION_MODE=0 -DCHAM_STATS_PER_SYNC_INTERVAL " cmake .
make install
...
make clean 
cmake -DCMAKE_INSTALL_PREFIX="~/chameleon/chameleon-lib/intel_no_communication_thread" -DCMAKE_CXX_FLAGS="-DCHAM_STATS_RECORD -DCHAM_STATS_PRINT -DENABLE_COMM_THREAD=0 -DCHAM_STATS_PER_SYNC_INTERVAL " cmake .
make install
...
export SAMOA_BIN="/home/ps659535/chameleon/samoa_chameleon/bin/samoa_4_unlimited"
#export SAMOA_PARAMS="-courant 0.1  -dmin 16 -dmax 16 -tmax 0.5 -lbtime  -drytolerance 0.0000010 -coastheight 0.00025 -sections 16 "
export SAMOA_PARAMS="-courant 0.1 -dmin 20 -dmax 20 -nmax 1000 -lbtime -drytolerance 0.0000010 -coastheight 0.00025 -sections 16 "

#export OUTPUT_DIR_PRE="/work/ps659535/aderdg_tests/aderdg_base_time_ccp_t${NTHREADS}_"
export OUTPUT_DIR_PRE="/work/ps659535/aderdg_tests/long_aderdg_base_time_ccp_t${NTHREADS}_"
export FILE_PRE="no_stealing_time_ccp"
#export NTHREADS=1
