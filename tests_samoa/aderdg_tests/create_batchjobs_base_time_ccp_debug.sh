...
make clean 
cmake -DCMAKE_INSTALL_PREFIX="~/chameleon/chameleon-lib/intel_no_communication_thread" -DCMAKE_CXX_FLAGS="-DCHAM_DEBUG -DCHAM_STATS_RECORD -DCHAM_STATS_PRINT -DENABLE_COMM_THREAD=0 -DCHAM_STATS_PER_SYNC_INTERVAL " cmake .
make install
...
#export SAMOA_BIN="inspxe-cl --collect mi1 -r debug /home/ps659535/chameleon/samoa_chameleon/bin/samoa_4_unlimited_cham_1"
...
export SAMOA_PARAMS="-courant 0.1 -dmin 20 -dmax 20 -nmax 10 -lbtime -drytolerance 0.0000010 -coastheight 0.00025 -sections 16 "

export OUTPUT_DIR_PRE="/work/ps659535/aderdg_tests/debug_base_time_ccp_t${NTHREADS}_"
