...
#export SAMOA_PARAMS="-courant 0.1  -dmin 16 -dmax 16 -tmax 0.5  -drytolerance 0.0000010 -coastheight 0.00025 -sections 16 "
export SAMOA_PARAMS="-courant 0.1 -dmin 20 -dmax 20 -nmax 10  -drytolerance 0.0000010 -coastheight 0.00025 -sections 16 "

export OUTPUT_DIR_PRE="/work/ps659535/aderdg_tests/aderdg_base_"
export FILE_PRE="no_stealing"
export NTHREADS=23
