...
def computeLoadImbalance(input_file_path):
  tmp_arr = []
  with open(input_file) as file: 
    for line in file:
      tmp_arr.append(line)

  rank_stats = [ch_stats.ChameleonStatsPerRank(i, False) for i in range(ranks)]
...
if __name__ == "__main__":
  ...
  load_imbalance = computeLoadImbalance(input_file)
